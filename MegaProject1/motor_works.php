...
<html lang="en">
  <head>
    ...
    <title>MotorWorks Service Hub</title>
    ...
    <link rel="stylesheet" href="css/motor_works.css" />
  ...
  <body>
    ...
    <div class="sidebar">
      ...
      <div class="sidebar-menu">
        ...
        <a href="motoworks.php">Bookings</a>
      </div>
...
if(isset($_POST['submit'])){
    ...
    $stmt = "INSERT INTO motorworks VALUES('$name','$email', $phone, '$c_name', '$c_model', '$c_reg', '$xyz', '$pickup', '$address', '$time', '$note', '$date')";
...
?>
      ...
      <div>
            <h1>Our Address:</h1>
            <center><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d122290.93040617096!2d74.16432680642745!3d16.69730931861695!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc101f5ed60dd2b%3A0x8e17b74465c4dc9c!2sS%20S%20Auto%20Works!5e0!3m2!1sen!2sin!4v1685114456932!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></https:></center>
        </div>
    </section>
